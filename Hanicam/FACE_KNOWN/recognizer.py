...
nb_p = 2
path = "/home/seydou/Hanicam/FACE_KNOWN/faces/s"
distances = []
resultats = []
collections = []
...
def deleteLink(link):
    ...
    lien = lien.replace('/home/seydou/Hanicam/FACE_KNOWN/faces/s/','')
...
def initializeCollection():
	 for i in range(1, 5) :
	 	collections.append(face.Collection(path+str(i)+"/"))
    ...
    if len(faces) > 0 :
    	for (x, y, w, h) in faces:
            ...
            for collection in collections :
            	...
            	resultats.append(rets)
            	distances.append(rets[0])
